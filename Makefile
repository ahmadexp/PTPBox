...
check: lint test standalone
	python3 -m py_compile agent/ptpbox_agent.py agent/ptpbox_research.py scripts/ptpboxctl.py scripts/ptpbox_kalman_servo.py scripts/ptpbox_event_monitor.py scripts/ptpbox_pps_compare.py scripts/probe-cabling.py
